...
def train(epoch):
    ...
    loss_train = masked_softmax_cross_entropy(output, labels, train_mask)
    ...
    loss_val = masked_softmax_cross_entropy(output,labels, val_mask)
...
def test():
    ...
    loss_test = masked_softmax_cross_entropy(output,labels, test_mask)
